...
\newcommand\dgCat{\ensuremath{\mathrm{dg\,Cat}}}
\DeclareDocumentCommand\dgMod{g}{\ensuremath{\IfNoValueF{#1}{#1\mhyphen}\mathrm{dg\,Mod}}}
\newcommand\sSet{\ensuremath{\simplicialCat{\Set}}}
\newcommand\simplicialCat[1]{\ensuremath{\mathbf{s\,\!#1}}}
\newcommand\simp{\ensuremath{\mathrm{s}}}
\DeclareDocumentCommand\grMod{g}{\ensuremath{\IfNoValueF{#1}{#1\mhyphen}\mathrm{gr-Mod}}}
...
%\input{simplicial_localization.tex}
%\input{Quasicategories.tex}
%\input{Segal.tex}
%\input{Simplicial_Presheaves.tex}
\input{dg}

\appendix

%\input{Simplicial_Sets.tex}
