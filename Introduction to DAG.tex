...
\bibliography{Bibliografia/Bibliography} %Path of the bibliography
\DeclareBibliographyCategory{model} 
\DeclareBibliographyCategory{simploc}
\DeclareBibliographyCategory{quasi}
\DeclareBibliographyCategory{segal}
\DeclareBibliographyCategory{simpsheaf}
\DeclareBibliographyCategory{higherstacks}
\DeclareBibliographyCategory{simpset}
\DeclareBibliographyCategory{enriched}

\defbibheading{local}{\section*{References}}

\newcommand*{\citemodel}[2][]{\addtocategory{model}{#2}\cite[#1]{#2}}
\newcommand*{\nocitemodel}[1]{\addtocategory{model}{#1}\nocite{#1}}

\newcommand*{\citesimploc}[2][]{\addtocategory{simploc}{#2}\cite[#1]{#2}}
\newcommand*{\nocitesimploc}[1]{\addtocategory{simploc}{#1}}

\newcommand*{\citequasi}[2][]{\addtocategory{quasi}{#2}\cite[#1]{#2}}
\newcommand*{\nocitequasi}[1]{\addtocategory{quasi}{#1}\nocite{#1}}

\newcommand*{\citesegal}[2][]{\addtocategory{segal}{#2}\cite[#1]{#2}}
\newcommand*{\nocitesegal}[1]{\addtocategory{segal}{#1}\nocite{#1}}

\newcommand*{\citesimpsheaf}[2][]{\addtocategory{simpsheaf}{#2}\cite[#1]{#2}}
\newcommand*{\nocitesimpsheaf}[1]{\addtocategory{simpsheaf}{#1}\nocite{#1}}

\newcommand*{\citehigherstacks}[2][]{\addtocategory{higherstacks}{#2}\cite[#1]{#2}}
\newcommand*{\nocitehigherstacks}[1]{\addtocategory{higherstacks}{#1}\nocite{#1}}

\newcommand*{\citesimpset}[2][]{\addtocategory{simpset}{#2}\cite[#1]{#2}}
\newcommand*{\nocitesimpset}[1]{\addtocategory{simpset}{#1}\nocite{#1}}

\newcommand*{\citeenriched}[2][]{\addtocategory{enriched}{#2}\cite[#1]{#2}}
\newcommand*{\nociteenriched}[1]{\addtocategory{enriched}{#1}\nocite{#1}}
...
\input{Capitoli/Model_Categories.tex}
\input{Capitoli/simplicial_localization.tex}
\input{Capitoli/Quasicategories.tex}
\input{Capitoli/Segal.tex}
\input{Capitoli/Simplicial_Presheaves.tex}

\appendix

\input{Appendici/Simplicial_Sets.tex}
\input{Appendici/Enriched_Categories.tex}
