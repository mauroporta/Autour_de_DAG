...
%This monoidal category is furthermore closed: given two dg vector spaces $V^\bullet, W^\bullet \in \dgMod{k}^{\le 0}$ we define their \emph{internal hom} $\dghom{k}(V^\bullet, W^\bullet)$ as the complex which is degree 
