...
\makeevenhead{headings}{\thepage}{}{Expos\'e \thechapter: \leftmark}
...
\author{
  Gabriele~\textsc{Vezzosi} \\[.3em] Pieter \textsc{Belmans}, Brice~\textsc{Le Grignou}, \\ Valerio~\textsc{Melani}, Mauro~\textsc{Porta} \\ Pietro~\textsc{Vertechi}, Yan~\textsc{Zhao}
}
...
\input{quasicategories}
\input{segal}
\input{simplicial-presheaves}
\input{higher-stacks}
\input{dg}

\appendix

\input{simplicial-sets}
\input{enriched-categories}
