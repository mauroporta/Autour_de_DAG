...
\begin{theorem}
  ...
  \begin{proof}[Sketch of a proof]
    ...
    \end{equation}
    and by \cite[corollary 1.3.7.4]{hagII} we obtain that it is a~$1$\dash geometric derived stack, locally of finite presentation\fixthis{introduce these notions}.
